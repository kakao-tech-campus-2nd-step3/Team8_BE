...
public class PointController {
    ...
    @PutMapping("/charge")
    public ResponseEntity<PointChargeResponse> savePointChargeRequest(@RequestAttribute("memberId") Long memberId,
    ...
    public ResponseEntity<Void> savePointWithdrawRequest(@RequestAttribute("memberId") Long memberId,
                                                         @RequestBody PointRequest request) {
    ...
    @GetMapping("/logs")
    public ResponseEntity<Page<PointLogResponse>> getPointLogs(@RequestAttribute("memberId") Long memberId,
