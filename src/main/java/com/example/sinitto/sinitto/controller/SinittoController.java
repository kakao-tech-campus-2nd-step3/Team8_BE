...
public class SinittoController {
    ...
    @GetMapping
    public ResponseEntity<SinittoResponse> getSinittoInfo(@RequestAttribute("memberId") Long memberId) {
        return ResponseEntity.ok(sinittoService.readSinitto(memberId));
    }

    @Operation(summary = "시니또 계좌 정보 조회", description = "시니또의 계좌 정보를 요청한다.")
    @GetMapping("/bank")
    public ResponseEntity<SinittoBankResponse> getSinittoBankInfo(@RequestAttribute("memberId") Long memberId) {
    ...
    @PostMapping("/bank")
    public ResponseEntity<String> createSeniorBankInfo(@RequestAttribute("memberId") Long memberId, @RequestBody SinittoBankRequest sinittoBankRequest) {
    ...
    @PutMapping
    public ResponseEntity<String> updateSinitto(@RequestAttribute("memberId") Long memberId, @RequestBody SinittoRequest sinittoRequest) {
    ...
    @PutMapping("/bank")
    public ResponseEntity<String> updateSinittoBankInfo(@RequestAttribute("memberId") Long memberId, @RequestBody SinittoBankRequest sinittoBankRequest) {
